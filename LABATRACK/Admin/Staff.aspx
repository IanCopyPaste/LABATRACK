    ...
    <form id="form1" runat="server">
        <div class="app">
            ...
            <main class="main">
                ...
                <div class="content">
                    <%-- The form sits on top in one row, and the account list below it gets the full width. --%>
                    <section class="card">
                        <div class="card-h">
                            <div>
                                <h2>Add a staff account</h2>
                                <div class="sub">Share the temporary password in person. New accounts get the Staff role; five wrong passwords lock an account for a few minutes.</div>
                            </div>
                            <%= Icons.Get("user-plus") %>
                        </div>
                        <div class="card-b form-strip">
                            <div class="field">
                                <label for="txtNewUsername">Username</label>
                                <asp:TextBox ID="txtNewUsername" runat="server" MaxLength="50" placeholder="e.g. jcruz" autocomplete="off" />
                            </div>
                            <div class="field">
                                <label for="txtNewPassword">Temporary password</label>
                                <asp:TextBox ID="txtNewPassword" runat="server" TextMode="Password" MaxLength="100" autocomplete="new-password" />
                                <span class="hint">At least 8 characters. Stored only as a salted PBKDF2 hash.</span>
                            </div>
                            <div class="field">
                                <label for="txtConfirmPassword">Confirm password</label>
                                <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" MaxLength="100" autocomplete="new-password" />
                            </div>
                            <div class="form-strip-actions">
